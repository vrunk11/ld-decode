...
void Sequencer::stackField(qint32 frameNumber, QVector<SourceVideo::Data> inputFields,
...
quint16 Sequencer::median(QVector<quint16> elements)
{
...
bool Sequencer::isDropout(DropOuts dropOuts, qint32 fieldX, qint32 fieldY)
{
...
QVector<quint16> Sequencer::diffDod(QVector<quint16> inputValues, LdDecodeMetaData::VideoParameters videoParameters, qint32 xPos)
{
